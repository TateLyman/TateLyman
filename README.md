...
| x402 Surface Check | Browser checker for x402 manifests and pasted no-payment 402 challenges: resource URLs, price fields, networks, browser header posture, metadata boundaries, and failure language. | [Tool](https://tateprograms.com/x402-surface-check.html) |
